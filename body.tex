...
The data science theme led us to emphasize
data analysis and exploration. As a result, we spent much
of the week teaching campers practical data organization and
manipulation skills to allow them to delve into data sets
on their own.
...
In the first offering, we had assumed that students would be excited
